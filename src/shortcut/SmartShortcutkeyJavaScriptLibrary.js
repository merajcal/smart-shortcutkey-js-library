    ...
    function SmartShortcutkeyJavaScriptLibrary() {
        ...
        function saveNewKey(code, key, finalLabel, targetBtn, prompt) {
            const data = {
                ...
                element: {
                    id: targetBtn.id,
                    className: targetBtn? targetBtn.getAttribute('class'): '',
